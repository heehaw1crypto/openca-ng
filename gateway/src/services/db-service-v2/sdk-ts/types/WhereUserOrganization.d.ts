 ...
 */
export declare type WhereUserOrganization = _WhereUserOrganization | {
    $and?: _WhereUserOrganization[];
} | {
    $or?: _WhereUserOrganization[];
};
export declare type _WhereUserOrganization = {
    id?: number | {
        $eq?: number;
    } | {
        $neq?: number;
