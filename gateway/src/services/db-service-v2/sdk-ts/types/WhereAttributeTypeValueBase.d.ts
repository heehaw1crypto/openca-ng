 ...
 */
export declare type WhereAttributeTypeValueBase = _WhereAttributeTypeValueBase | {
    $and?: _WhereAttributeTypeValueBase[];
} | {
    $or?: _WhereAttributeTypeValueBase[];
};
export declare type _WhereAttributeTypeValueBase = {
    enum?: string | {
        $eq?: string;
    } | {
        $neq?: string;
