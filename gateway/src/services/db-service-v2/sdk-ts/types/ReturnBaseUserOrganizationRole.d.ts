import type { ReturnBaseOrganizationRole } from "./ReturnBaseOrganizationRole";
 ...
 */
export interface ReturnBaseUserOrganizationRole {
    id?: number;
    userId?: number;
    ...
    userUuid?: string;
    organizationRole?: ReturnBaseOrganizationRole;
    user?: ReturnBaseUser;
    [k: string]: unknown;
}
