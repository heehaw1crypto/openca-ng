 ...
 */
export declare type WhereRiskReductionMeasure = _WhereRiskReductionMeasure | {
    $and?: _WhereRiskReductionMeasure[];
} | {
    $or?: _WhereRiskReductionMeasure[];
};
export declare type _WhereRiskReductionMeasure = {
    id?: number | {
        $eq?: number;
    } | {
        $neq?: number;
