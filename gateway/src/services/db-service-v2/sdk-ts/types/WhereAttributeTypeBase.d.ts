 ...
 */
export declare type WhereAttributeTypeBase = _WhereAttributeTypeBase | {
    $and?: _WhereAttributeTypeBase[];
} | {
    $or?: _WhereAttributeTypeBase[];
};
export declare type _WhereAttributeTypeBase = {
    enum?: string | {
        $eq?: string;
    } | {
        $neq?: string;
