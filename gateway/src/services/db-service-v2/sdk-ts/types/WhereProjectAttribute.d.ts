 ...
 */
export declare type WhereProjectAttribute = _WhereProjectAttribute | {
    $and?: _WhereProjectAttribute[];
} | {
    $or?: _WhereProjectAttribute[];
};
export declare type _WhereProjectAttribute = {
    id?: number | {
        $eq?: number;
    } | {
        $neq?: number;
