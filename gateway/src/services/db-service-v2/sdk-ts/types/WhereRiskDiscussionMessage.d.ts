 ...
 */
export declare type WhereRiskDiscussionMessage = _WhereRiskDiscussionMessage | {
    $and?: _WhereRiskDiscussionMessage[];
} | {
    $or?: _WhereRiskDiscussionMessage[];
};
export declare type _WhereRiskDiscussionMessage = {
    id?: number | {
        $eq?: number;
    } | {
        $neq?: number;
