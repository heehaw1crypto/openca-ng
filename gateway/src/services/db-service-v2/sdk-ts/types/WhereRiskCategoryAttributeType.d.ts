 ...
 */
export declare type WhereRiskCategoryAttributeType = _WhereRiskCategoryAttributeType | {
    $and?: _WhereRiskCategoryAttributeType[];
} | {
    $or?: _WhereRiskCategoryAttributeType[];
};
export declare type _WhereRiskCategoryAttributeType = {
    id?: number | {
        $eq?: number;
    } | {
        $neq?: number;
