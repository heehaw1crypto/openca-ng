 ...
 */
export declare type WhereCertificateAuthorityToken = _WhereCertificateAuthorityToken | {
    $and?: _WhereCertificateAuthorityToken[];
} | {
    $or?: _WhereCertificateAuthorityToken[];
};
export declare type _WhereCertificateAuthorityToken = {
    id?: number | {
        $eq?: number;
    } | {
        $neq?: number;
