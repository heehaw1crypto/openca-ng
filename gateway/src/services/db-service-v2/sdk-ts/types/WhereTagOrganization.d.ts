 ...
 */
export declare type WhereTagOrganization = _WhereTagOrganization | {
    $and?: _WhereTagOrganization[];
} | {
    $or?: _WhereTagOrganization[];
};
export declare type _WhereTagOrganization = {
    id?: number | {
        $eq?: number;
    } | {
        $neq?: number;
