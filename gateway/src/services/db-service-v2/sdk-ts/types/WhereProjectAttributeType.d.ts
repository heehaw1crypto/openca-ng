 ...
 */
export declare type WhereProjectAttributeType = _WhereProjectAttributeType | {
    $and?: _WhereProjectAttributeType[];
} | {
    $or?: _WhereProjectAttributeType[];
};
export declare type _WhereProjectAttributeType = {
    id?: number | {
        $eq?: number;
    } | {
        $neq?: number;
