 ...
 */
export declare type WhereCspCapability = _WhereCspCapability | {
    $and?: _WhereCspCapability[];
} | {
    $or?: _WhereCspCapability[];
};
export declare type _WhereCspCapability = {
    id?: number | {
        $eq?: number;
    } | {
        $neq?: number;
