 ...
 */
export declare type WhereRiskCategoryAttribute = _WhereRiskCategoryAttribute | {
    $and?: _WhereRiskCategoryAttribute[];
} | {
    $or?: _WhereRiskCategoryAttribute[];
};
export declare type _WhereRiskCategoryAttribute = {
    id?: number | {
        $eq?: number;
    } | {
        $neq?: number;
