 ...
 */
export declare type WhereRiskReductionMeasureType = _WhereRiskReductionMeasureType | {
    $and?: _WhereRiskReductionMeasureType[];
} | {
    $or?: _WhereRiskReductionMeasureType[];
};
export declare type _WhereRiskReductionMeasureType = {
    id?: number | {
        $eq?: number;
    } | {
        $neq?: number;
