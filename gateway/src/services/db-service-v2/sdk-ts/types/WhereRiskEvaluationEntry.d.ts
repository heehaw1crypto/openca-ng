 ...
 */
export declare type WhereRiskEvaluationEntry = _WhereRiskEvaluationEntry | {
    $and?: _WhereRiskEvaluationEntry[];
} | {
    $or?: _WhereRiskEvaluationEntry[];
};
export declare type _WhereRiskEvaluationEntry = {
    id?: number | {
        $eq?: number;
    } | {
        $neq?: number;
