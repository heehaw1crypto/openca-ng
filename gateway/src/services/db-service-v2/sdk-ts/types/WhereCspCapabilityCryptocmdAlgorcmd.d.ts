 ...
 */
export declare type WhereCspCapabilityCryptocmdAlgorcmd = _WhereCspCapabilityCryptocmdAlgorcmd | {
    $and?: _WhereCspCapabilityCryptocmdAlgorcmd[];
} | {
    $or?: _WhereCspCapabilityCryptocmdAlgorcmd[];
};
export declare type _WhereCspCapabilityCryptocmdAlgorcmd = {
    id?: number | {
        $eq?: number;
    } | {
        $neq?: number;
