 ...
 */
export declare type WhereRiskAvoidability = _WhereRiskAvoidability | {
    $and?: _WhereRiskAvoidability[];
} | {
    $or?: _WhereRiskAvoidability[];
};
export declare type _WhereRiskAvoidability = {
    id?: number | {
        $eq?: number;
    } | {
        $neq?: number;
