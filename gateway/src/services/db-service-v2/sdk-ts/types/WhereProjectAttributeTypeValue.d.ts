 ...
 */
export declare type WhereProjectAttributeTypeValue = _WhereProjectAttributeTypeValue | {
    $and?: _WhereProjectAttributeTypeValue[];
} | {
    $or?: _WhereProjectAttributeTypeValue[];
};
export declare type _WhereProjectAttributeTypeValue = {
    id?: number | {
        $eq?: number;
    } | {
        $neq?: number;
