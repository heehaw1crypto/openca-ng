 ...
 */
export declare type WhereCertificateTokenState = _WhereCertificateTokenState | {
    $and?: _WhereCertificateTokenState[];
} | {
    $or?: _WhereCertificateTokenState[];
};
export declare type _WhereCertificateTokenState = {
    id?: number | {
        $eq?: number;
    } | {
        $neq?: number;
