 ...
 */
export declare type WhereCspCapabilityCryptocmd = _WhereCspCapabilityCryptocmd | {
    $and?: _WhereCspCapabilityCryptocmd[];
} | {
    $or?: _WhereCspCapabilityCryptocmd[];
};
export declare type _WhereCspCapabilityCryptocmd = {
    id?: number | {
        $eq?: number;
    } | {
        $neq?: number;
