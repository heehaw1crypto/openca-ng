 ...
 */
export declare type WhereCertificateAuthorityCertificateToken = _WhereCertificateAuthorityCertificateToken | {
    $and?: _WhereCertificateAuthorityCertificateToken[];
} | {
    $or?: _WhereCertificateAuthorityCertificateToken[];
};
export declare type _WhereCertificateAuthorityCertificateToken = {
    id?: number | {
        $eq?: number;
    } | {
        $neq?: number;
