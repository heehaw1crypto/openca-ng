 ...
 */
export declare type WhereRiskCategoryProject = _WhereRiskCategoryProject | {
    $and?: _WhereRiskCategoryProject[];
} | {
    $or?: _WhereRiskCategoryProject[];
};
export declare type _WhereRiskCategoryProject = {
    id?: number | {
        $eq?: number;
    } | {
        $neq?: number;
