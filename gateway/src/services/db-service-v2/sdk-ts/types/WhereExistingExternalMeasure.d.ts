 ...
 */
export declare type WhereExistingExternalMeasure = _WhereExistingExternalMeasure | {
    $and?: _WhereExistingExternalMeasure[];
} | {
    $or?: _WhereExistingExternalMeasure[];
};
export declare type _WhereExistingExternalMeasure = {
    id?: number | {
        $eq?: number;
    } | {
        $neq?: number;
