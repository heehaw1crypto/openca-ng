 ...
 */
export declare type WhereUserOrganizationRole = _WhereUserOrganizationRole | {
    $and?: _WhereUserOrganizationRole[];
} | {
    $or?: _WhereUserOrganizationRole[];
};
export declare type _WhereUserOrganizationRole = {
    id?: number | {
        $eq?: number;
    } | {
        $neq?: number;
