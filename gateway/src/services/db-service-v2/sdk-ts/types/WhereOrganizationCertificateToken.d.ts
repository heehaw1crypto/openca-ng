 ...
 */
export declare type WhereOrganizationCertificateToken = _WhereOrganizationCertificateToken | {
    $and?: _WhereOrganizationCertificateToken[];
} | {
    $or?: _WhereOrganizationCertificateToken[];
};
export declare type _WhereOrganizationCertificateToken = {
    id?: number | {
        $eq?: number;
    } | {
        $neq?: number;
