 ...
 */
export declare type WhereOrganizationRole = _WhereOrganizationRole | {
    $and?: _WhereOrganizationRole[];
} | {
    $or?: _WhereOrganizationRole[];
};
export declare type _WhereOrganizationRole = {
    id?: number | {
        $eq?: number;
    } | {
        $neq?: number;
